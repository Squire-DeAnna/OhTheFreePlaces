...
$city_id = filter_input(INPUT_GET, 'city_id', FILTER_VALIDATE_INT);   
 ...
 //----------------attrraction page actions 
    ...
    $current_attraction = $attractionDB->get_attraction();
    $attraction = $attractionDB->get_attraction();
...
?>
<body>
<header><h1>Oh the Free Places You'll Go!</h1></header>
